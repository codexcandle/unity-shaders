...
// SOURCE:  	https://digitalerr0r.wordpress.com/2015/10/26/unity-5-shader-programming-3-specular-light/
// TYPE:		fragment
// FUNCTION:	Specular light Global - basic shader 101.  
// 				(-using GlobalStates constants!)
Shader "!_custom/-digitalerr0r/SpecularLightGlobal"
{
	SubShader
	{
        Pass
