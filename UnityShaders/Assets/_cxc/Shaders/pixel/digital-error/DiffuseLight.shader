...
// TYPE:		fragment
// FUNCTION:	Diffuse light - basic shader 101.  
// 				(-but, maybe don't use this one as you 
//				have to set "light direction," etc.)
Shader "!_custom/-digitalerr0r/DiffuseLight"
{
	Properties
	{
	...
	SubShader
	{
		Pass
		{
			...
			float4 fragmentShader(vsOut psIn):SV_Target
			{
				...
				return (_AmbientLightColor * _AmbientLightIntensity) + (diffuse * _DiffuseColor * _DiffuseIntensity);
			}
			ENDCG
		}
	}
