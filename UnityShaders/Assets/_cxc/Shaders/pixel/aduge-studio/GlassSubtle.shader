...
// SOURCE:  	Mauricio Perin (aka @maperns for Aduge Studio/Zueira Digital)
// TYPE:		fragment
// FUNCTION:	Per pixel bumped refraction, uses a normal map to distort the 
// 				image behind, and two additional textures to tint and highlight.
Shader "!_custom/-gamasutra/GlassSubtle"
{
	Properties
	{
		_MainTex("Tine Color(RGB)", 2D) = "white"{}
	...
	Category
	{
		// transparent so objects behind the shader are drawn beforehand
		...
		SubShader
		{
			...
			// the main pass takes the generated texture & uses the bumpmap
			...
			Pass
			{
				...
				half4 frag(v2f i):COLOR
				{
					...
					// - could optimize this by just reading the x & y without reconstructing the Z
					...
					// adding higlight at 20% strentgh then doing darkening color effect
